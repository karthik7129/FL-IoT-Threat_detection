...
def load_and_preprocess_data():
    ...
    """
    # Read the dataset
    df = pd.read_csv("ReducedData/device_5_reduced.csv")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='Federated Learning Client 3')
    parser.add_argument(
        '--server',
        type=str,
    ...
    print(f"Client 3 connecting to server: {args.server}")
    start_client(
